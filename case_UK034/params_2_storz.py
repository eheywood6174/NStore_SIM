...
def params_2_storz(storz, param_vec):
    ...
    storz_t[0][0] = satd_exp(param_vec[0], 0.1, 100) #Input power 2
    storz_t[0][1] = satd_exp(param_vec[1], 0.1, 100) #Output power 2
    storz_t[0][2] = satd_exp(param_vec[2], 0.1, 10E3) #Storage capacity 2
    storz_t[1][0] = satd_exp(param_vec[3], 0.1, 100) #Input power 3
    storz_t[1][1] = satd_exp(param_vec[4], 0.1, 100) #Output power 3
    storz_t[1][2] = satd_exp(param_vec[5], 0.1, 100E3) #Storage capacity 3
