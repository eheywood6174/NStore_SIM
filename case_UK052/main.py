...
The system considered here uses four types of storage/flexibility ... 
ACAES + WIS + H2 + gas.
"""
...
stocosts0 = np.array([[220.0, 280.0, 3.911, 4.0, 4.0, 2.0, 30, 30, 30, -1],
                      [16.7, 16.7, 10.0, 3.0, 3.0, 2.0, 35, 35, 35, -1],
