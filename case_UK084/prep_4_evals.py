...
def prep_4_evals(storz, edcost):
    ...
    parm_vec_0 = np.array([inv_satd_exp(storz[0,0], 0.1, 100),
                           inv_satd_exp(storz[0,1], 0.1, 100),
                           inv_satd_exp(storz[0,2], 0.1, 10E3),
                           inv_satd_exp(storz[1,0], 0.1, 100),
                           inv_satd_exp(storz[1,1], 0.1, 100),
                           inv_satd_exp(storz[1,2], 0.1, 10E3),
                           inv_satd_exp(storz[2,0], 0.1, 400),
                           inv_satd_exp(storz[2,1], 0.1, 400),
                           inv_satd_exp(storz[2,2], 0.1, 100E3)])
